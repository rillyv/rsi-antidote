...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander( // Base layout
    ...
    KC_TAB, KC_Q, KC_W, KC_F, KC_P, KC_G, KC_PSCR, KC_NO, KC_J, KC_L, KC_U, KC_Y, KC_SCLN, BACKSLASH_HASH,
    ...
    KC_BSPC, KC_DELETE, TO(3), TO(4), KC_ENTER, KC_SPACE
  ),
  ...
  [3] = LAYOUT_moonlander( // QWERTY Gaming layout
    ...
    KC_LEFT_CTRL, KC_LEFT_GUI, KC_NO, KC_LEFT_ALT, KC_SPACE, KC_NO, KC_NO, KC_NO, KC_LEFT, KC_UP, KC_DOWN, KC_RIGHT,
    KC_BSPC, KC_DELETE, TO(0), KC_NO, KC_ENTER, KC_SPACE
  ),
  [4] = LAYOUT_moonlander( // COLEMAK Gaming layout
    ...
    KC_LEFT_CTRL, KC_LEFT_GUI, KC_NO, KC_LEFT_ALT, KC_SPACE, KC_NO, KC_NO, KC_NO, KC_LEFT, KC_UP, KC_DOWN, KC_RIGHT,
    KC_BSPC, KC_DELETE, KC_NO, TO(0), KC_ENTER, KC_SPACE
  ),
};
